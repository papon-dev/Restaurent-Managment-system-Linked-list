...
struct node* createadmin(struct node *head,int data, char fname[50], float price)
{
...
struct node* createcustomer(struct node *head,int data,int quantity)
{
    ...
    if(flag==1)
    {
        ...
        strcpy(newnode->fname,temp1->fname);
        newnode->next = NULL;
        newnode->prev = NULL;
...
void displayList(struct node *head)
{
    ...
    else
    {
        ...
        {
            if(temp1->quantity==0)
                printf("\t\t\t\t\t\t%d\t%s\t%0.2f\n",temp1->data,temp1->fname,temp1->price);
            else
            {
                printf("\t\t\t\t\t\t%d\t%s\t%d\t%0.2f\n",temp1->data,temp1->fname,temp1->quantity,temp1->price);
            }
...
int main()
{
    heada = createadmin(heada,1,"Hot Coffee",100);
    heada = createadmin(heada,2,"Soup",200);
    heada = createadmin(heada,3,"Noodles",150);
    heada = createadmin(heada,4,"Fried Rice",180);
    heada = createadmin(heada,5,"Bear",500);
